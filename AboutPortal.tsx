...
const AboutPortal: React.FC<AboutPortalProps> = ({ currentUser }) => {
  const isFounder = currentUser?.email === 'jemalfano030@gmail.com' || currentUser?.email === 'jemalfan030@gmail.com' || currentUser?.email === 'admin@iftu.edu.et';
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-6 bg-gray-50 p-6 rounded-3xl border-4 border-black">
                ...
                <div>
                  ...
                  <p className="text-lg font-black italic">admin@iftu.edu.et</p>
                  <p className="text-[10px] font-black uppercase text-gray-400 mt-2">Secondary Email</p>
                  <p className="text-sm font-bold italic text-gray-600">jemalfano030@gmail.com</p>
                </div>
              </div>
              <div className="flex items-center gap-6 bg-gray-50 p-6 rounded-3xl border-4 border-black">
                <div className="text-4xl">📍</div>
